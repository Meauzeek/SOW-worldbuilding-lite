...
基准：完整版提交 3f23f2ce378aecb91cf861325931a2449132e57f，整理日期 2026-09-15。精简版与完整版独立维护，不会自动覆盖或同步对方。

作者世界观资料的权利归原作者所有。第三方地图来源及 D3 许可见 [来源与许可](docs/SOURCES.md)。

城市标记在完整版与精简版共用同一绘制规范：国家首都为灰品红色粗外圈、细内圈和中心点组成的三层标记（缩远简化），地区首府为蓝灰双空心环，城市为实心点，城镇为空心环。均有淡白衬边；各类标记均按最外圈半径匹配人口，内部圆圈向内排列，随缩放调整。省级/地区行政中心预设参照 Natural Earth 现实原型，支持编辑。
